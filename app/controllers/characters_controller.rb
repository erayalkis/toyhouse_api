class CharactersController < ApplicationController
  ...
  def profile
    fetch_and_send_response(params[:id], "default")
  end

  def details
    fetch_and_send_response(params[:id], "details_only")
  end

  def gallery
    fetch_and_send_response(params[:id], "gallery_only")
  end

  def favorites
    fetch_and_send_response(params[:id], "favorites")
  end
  ...
  def fetch_and_send_response(id, scraper_type)
    data = fetch_character_data(id, scraper_type)
  ...
  def fetch_character_data(id, scraper_type)
